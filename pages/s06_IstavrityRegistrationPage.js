...
class IstavrityRegistrationPage {
  constructor(page) {
    this.page = page;
  ...
  async fillPersonalInfo(name, email, phone) {
  ...
  async fillAddressInfo(address, street, city, postCode) {
...
module.exports = { IstavrityRegistrationPage };
